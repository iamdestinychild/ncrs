...
export default function SideBar() {
    ...
    return (
        <div ref={sideBarRef} className={`${styles.sidebar} ${sideBarState.sideBar?styles.slide_sidebar:``}`}>
            ...
            <DropDown text="Services">
                    <ul>
                        <li><Link href="/services" className={styles.sidebar_dropdown_link}>Our Services</Link></li>
                        <li><Link href="downloads" className={styles.sidebar_dropdown_link}>Downloads</Link></li>
                </ul>
            </DropDown>
            <DropDown text="Media">
                    <ul>
                        <li><Link href="/news" className={styles.sidebar_dropdown_link}>News</Link></li>
                        <li><Link href="/gallery" className={styles.sidebar_dropdown_link}>Gallery</Link></li>
                </ul>
            </DropDown>
            <li><Link href="/consultancy" className={styles.sidebar_dropdown_link}>Consultancy</Link></li>    
            <li><Link href="/contact" className={styles.sidebar_dropdown_link}>Contact Us</Link></li>
        </ul>
            </div>
    )
}