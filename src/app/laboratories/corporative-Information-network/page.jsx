          ...
          <div className={styles.hero_title_page}>
            ...
            <div className={styles.page_cover}>
              <h1 className={styles.page}>
                Corporative Information Network (COPINE) South-West Zonal Lab.
                Ile-Ife
              </h1>
            </div>
          </div>
      ...
      <section className={styles.section_two}>
        <div className={styles.section_two_container}>
          ...
          <p className={styles.section_two_parapgrah}>
            It was established in 1995 at the South Western zone of Nigeria
            through the initiative of the UN office for outer space affairs
            (UNOSA) with the aim of responding to the immediate information
            exchange needs of African countries for development. COPINE was
            later transferred in JUNE 2010 to NASRDA with the approval of the
            honorable minister of science and technology and refocused a new
            mandate on the application of remote sensing and GIS for sustainable
            national economic development. COPINE is the first regional space
            application laboratory located in the south west geopolitical zone
            of Nigeria for space technology application to bring its product and
            services to relevant stakeholders in the region and environs.it is
            first of the six (6) space application laboratories established by
            NASRDA and coordinated by National Centre for Remote Sensing Jos.
          </p>
        </div>
      </section>
