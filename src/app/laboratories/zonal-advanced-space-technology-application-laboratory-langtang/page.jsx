          ...
          <div className={styles.hero_title_page}>
            ...
            <div className={styles.page_cover}>
              <h1 className={styles.page}>
                Zonal Advanced Space Technology Applications Laboratory (ZASTAL)
                Langtang
              </h1>
            </div>
          </div>
      ...
      <section className={styles.section_two}>
        <div className={styles.section_two_container}>
          ...
          <p className={styles.section_two_parapgrah}>
            It was established on the 27th November, 2018 at the North-Central
            Geo-Political Zone of Nigeria with a specific mandate focusing on
            the environmental situation in Plateau State and its environs.it is
            the sixth Zonal Laboratory to be established by NASRDA and
            coordinated by NCRS Jos.
          </p>
        </div>
      </section>
