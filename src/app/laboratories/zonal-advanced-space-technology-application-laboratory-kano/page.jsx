        ...
        <main>
                ...
                <div className={styles.hero_content}>
                    ...
                    <div className={styles.hero_title_page}>
                        ...
                        <div className={styles.page_cover}>
                            <h1 className={styles.page}>Zonal Advanced Space Technology Application Laboratory (ZASTAL) Kano </h1>
                        </div>
                    </div>
                </div>
            </section>
            <section className={styles.section_two}>
                <div className={styles.section_two_container}>
                    ...
                    <p className={styles.section_two_parapgrah}>It was established within the premise of the Faculty of Agriculture, Bayero University, Kano on the 9th November, 2011 at the North -West Geo-Political Zone of Nigeria with a specific mandate focusing on the environmental situation in Kano State and its environs.it is the third zonal laboratory to be established by NASRDA and coordinated by NCRS Jos.</p>
                </div>
            </section>
