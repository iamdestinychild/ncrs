    ...
    <main>
      ...
      <section className={styles.section_two}>
        <div className={styles.section_two_inner}>
          ...
          <h1 className={styles.section_two_inner_heading}>Services</h1>
          <div className={styles.banner_text}>
            <div className={styles.section_two_banner_container}>
              <Image
                src="/images/service-img.jpg"
                alt="image"
                className={styles.section_two_banner}
                fill
              />
            </div>
            <p>
              Nigeria&apos;s plan to establish a comprehensive Remote Sensing
              Centre dates back to 1976, following studies by the Food and
              Agricultural Organization (FAO) that emphasized the need for such
              a center. In 1998, the National Council of Ministers approved the
              establishment of the National Centre for Remote Sensing (NCRS) in
              Jos, with a Satellite Ground Receiving Station in Kerang, Plateau
              State. Initially overseen by the Federal Ministry of Science,
              Technology, and Innovation, responsibility shifted to the National
              Agency for Science and Engineering Infrastructure (NASENI) in
              1992. The NCRS began operations in 1995 and now operates under the
              National Space Research and Development Agency (NASRDA), which was
              established in 1999. NCRS is responsible for satellite data
              acquisition, imagery distribution, and capacity building to
              support socio-economic development in Nigeria.
            </p>
          </div>
          <div className={styles.cards}>
            <Link
              href="/services/satallite-data-services"
            ...
            <Link
              href="/services/natural-resource-mapping"
              className={styles.card}
            >
            ...
            <Link
              href="/services/urban-rural-planning-development"
              className={styles.card}
            >
              <Procurement customStyle={styles.icon} />
              <h1>Urban and Rural Planning </h1>
            </Link>
