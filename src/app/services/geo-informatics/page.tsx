            ...
            <section className={styles.section_two}>
                <div className={styles.section_two_inner}>
                    <div className={styles.section_two_heading}>
                        <h1>Geo-Informantics</h1>
                        <p>NCRS&apos;s Geo-informatics offers specialized geo-spatial solutions that support a wide range of applications, leveraging advanced GIS technologies:</p>
                    </div>
                    <div className={styles.banner_text}>
                        <div className={styles.section_two_banner_container}>
                            <Image src='/images/services-07.jpg' alt='image' className={styles.section_two_banner} fill/>
                        </div>
                        <div className={styles.banner_text_content}>
                            <p className={styles.content_p}>We offer:</p>
                            <ul className={styles.content_list}>
                                <li>Spatial Data Management: Collect, store, and manage  geo-spatial data.</li>
                                <li>Custom GIS Applications: Develop tailored GIS solutions for  specific needs.</li>
                                <li>Data Analysis and Visualization: Analyze spatial data and create visual representations for better understanding.</li>
                            </ul>
                       </div>
                    </div>
                    ...
                    <Link href='/services/satallite-data-services' className={styles.card}>
                        ...
                        <Link href='/services/geo-informatics' className={`${styles.card} bg-primary text-white`}>
