      ...
      <section className={styles.hero}>
        ...
        <div className={styles.hero_content}>
          ...
          <p className={styles.heading_two}>
            Our Visions, Mission and Our Team
          </p>
      ...
      <section className={styles.section_two}>
        <div className={styles.section_two_inner}>
          <div className={styles.section_two_heading}>
            ...
            <p>
              The Centre&apos;s Water Resources focuses on the monitoring and
              management of Nigeria&apos;s water bodies, utilizing remote
          ...
          <div className={styles.banner_text}>
            ...
            <div className={styles.banner_text_content}>
              ...
              <ul className={styles.content_list}>
                <li>
                  Hydrological Mapping: Monitor and map rivers, lakes, and
                  groundwater resources.
                </li>
                <li>
                  Water Quality Assessment: Evaluate the quality of water bodies
                  for safe consumption and use.
                </li>
                <li>
                  Irrigation Planning: Support the development of efficient
                  irrigation systems.
                </li>
              </ul>
            </div>
          ...
          <div className={styles.application}>
            ...
            <ul>
              <li>
                Water Management: Ensure sustainable use and management of water
                resources.
              </li>
              <li>
                Agricultural Support: Enhance agricultural productivity through
                effective water management.
              </li>
              <li>
                Environmental Protection: Monitor water bodies to prevent
          ...
          <div className={styles.cards}>
            ...
            <Link href="/services/water-resources" className={`${styles.card} bg-primary text-white`}>
              <Station customStyle={styles.icon} />
              <h1>Water Resources</h1>
            </Link>
