      ...
      <section className={styles.section_two}>
        <div className={styles.section_two_container}>
          <div className={styles.section_two_container_form_map}>
            ...
            <p className={styles.section_two_container_paragraph}>
              Got any questions about us and our projects and programs? We’re
              here to help and assist you
            </p>
            <form className={styles.section_two_form}>
              <div className={styles.section_two_form_cover}>
                <label htmlFor="name" className={styles.section_two_form_label}>
                  Full Name
                </label>
                <input
                  type="text"
                  className={styles.section_two_form_input}
                  id="name"
                />
                <label
                  htmlFor="email"
                  className={styles.section_two_form_label}
                >
                  Email
                </label>
                <input
                ...
                <textarea
                  className={`${styles.section_two_form_input} ${styles.message_field}`}
                  id="message"
                ></textarea>
              </div>
              ...
              <input
                type="submit"
                className={styles.section_two_form_submit}
                placeholder="Submit"
              />
            </form>
          ...
          <div className={styles.section_two_banner_cover}>
            {/* <div style="width: 100%"> */}
              <iframe
                ...
                marginheight="0"
                marginwidth="0"
                          // src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=9.8976, 9.0050&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                src="https://maps.google.com/maps?q=9.897626,9.005001&z=15&output=embed"
              >
